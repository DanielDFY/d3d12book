...
// Exercise_11_09 BlendApp.cpp modified by DanielDFY
...
{
	// Modify: to visualize depth complexity, pass all depth tests and enable depth writing
	...
	// Modify: accumulate pixel color by blending
...
void BlendApp::BuildRenderItems()
{
	...
	// Modify: now all objects are transparent
