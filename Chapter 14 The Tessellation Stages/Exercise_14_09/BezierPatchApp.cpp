//***************************************************************************************
// BezierPatchApp.cpp by DanielDFY
//***************************************************************************************

// Implement B¨¦zier triangle patches
...
void BezierPatchApp::BuildTrianglePatchGeometry()
{
	//      1					
	//    2   3
	//  4   5   6
	...
	triangleSubmesh.IndexCount = static_cast<UINT>(indices.size());
	triangleSubmesh.StartIndexLocation = 0;
	triangleSubmesh.BaseVertexLocation = 0;

	geo->DrawArgs["trianglePatch"] = triangleSubmesh;
...
void BezierPatchApp::BuildPSOs()
{
	...
	// error in surface normal computation in shader, use wire-frame to avoid visual bug 
...
void BezierPatchApp::BuildRenderItems()
{
	...
	trianglePatchRitem->PrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_10_CONTROL_POINT_PATCHLIST;
