...
* Chapter 08 Lighting
  ...
  * [ ] *Exercise_08_06*
    ...
    > Modify the *LitWaves* demo to use the sort of cartoon shading as follows:<br><img src=".\Chapter 08 Lighting\Exercise_08_06\cartoon shading function.png" alt="cartoon shading function" style="zoom:75%;" align="left"/><br>(Note: The
functions f and g above are just sample functions to start with, and can be tweaked until you get the results we want.)
