...
void NormalMapApp::UpdateObjectCBs(const GameTimer& gt)
{
	...
	for (auto& e : mAllRitems)
	{
		...
		XMMATRIX texMatrix = XMLoadFloat4x4(&e->TexTransform);
		//************************************
		float t = 0.0f;
		t += gt.DeltaTime();
		if (t > MathHelper::Pi)
		...
		//************************************
		if (e->Mat->Name == "tile0")		
			XMStoreFloat4x4(&e->TexTransform, texMatrix* XMMatrixTranslation(-0.08f*t, -0.15f*t, 0.0f));
		//if(e->Mat->Name == "tile1")
		//	XMStoreFloat4x4(&e->TexTransform, texMatrix*XMMatrixTranslation(0.04f*t, 0.06f*t, 0.0f));
...
void NormalMapApp::LoadTextures()
{
	...
	std::vector<std::wstring> texFilenames = 
	{
		...
		L"Textures/waves0_NRM.dds",
		L"Textures/waves1_DISP.dds",
		L"Textures/waves1_NRM.dds",
...
void NormalMapApp::BuildDescriptorHeaps()
{
	...
	std::vector<ComPtr<ID3D12Resource>> tex2DList = 
	{
		...
		mTextures["tileHeightMap0"]->Resource,
		mTextures["tileNormalMap0"]->Resource,
		mTextures["tileHeightMap1"]->Resource,
		mTextures["tileNormalMap1"]->Resource,
...
void NormalMapApp::BuildMaterials()
{
	...
	tile0->DiffuseAlbedo = XMFLOAT4(0.3f, 0.2f, 0.7f, 1.0f);
	...
	tile1->NormalSrvHeapIndex = 5;
	tile1->DiffuseAlbedo = XMFLOAT4(0.4f, 0.4f, 0.7f, 1.0f);
	...
	mMaterials["tile1"] = std::move(tile1);
